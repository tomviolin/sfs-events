...
ics_sources = [
	...
	{url:'/proxy.php?url='+encodeURI('https://panthers.sharepoint.com/:u:/s/SFSReservations/EVNzyA8WSLlArxqvObj64OABXDugCXC7-xXCfLjbshF6KQ?e=eudWcv'), title:'ROAR Room Reservations', prefix:'🚪', event_properties:{color: '#ccffcc'}},
