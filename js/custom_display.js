...
ics_sources = [
	...
	{url:'/proxy.php?url='+encodeURI('https://25livepub.collegenet.com/calendars/uwm-sfs-all-events.ics?previousweeks=12'), title:'ROAR Room Reservations', prefix:'🚪', event_properties:{color: '#ccffcc'}},
